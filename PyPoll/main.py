...
# Xpert Learning Assistant provided guidance re how to report each candidate/vote count on separate line, correct syntax to report percentage of votes for each candidate
...
# Xpert Learning Assistant provided guidance re syntax to use max on dictionary    
